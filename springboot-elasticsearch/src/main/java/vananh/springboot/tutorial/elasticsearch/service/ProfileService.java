package vananh.springboot.tutorial.elasticsearch.service;
...
import vananh.springboot.tutorial.elasticsearch.util.Constant;
...
public class ProfileService {
    ...
    private String INDEX = Constant.INDEX;

    private String TYPE = Constant.TYPE;
